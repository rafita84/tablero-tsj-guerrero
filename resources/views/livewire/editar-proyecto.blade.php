                                        ...
                                        @if ($ruta_imagen)
                                            <div>
                                                <img
                                                    ...
                                                    src="{{ $ruta_imagen }}" alt="Previsualización"/>
                                                <button
                                    ...
                                    @if(count($recursos))
                                        ...
                                        @foreach($recursos as $key => $recurso)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ number_format($recurso['costo'], 2) }}</td>
                                                <td class="px-4 py-3 sm:px-5 text-right">
                                                    <button
                                                        class="badge rounded-full  text-error bg-error/10 hover:bg-error/20"
                                                        wire:click.prevent="borrarRecurso({{$key}})"><i
                                ...
                                <table class="is-zebra w-full text-left">
                                    @if(count($areas))
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right whitespace-nowrap bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                                                Borrar
                                            </th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($areas as $key => $area)
                                            <tr>
                                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $area['nombre'] }}</td>
                ...
                <label class="block">
                    <div>
                        <label class="block mb-1">
                            ...
                            <input
                                class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                value="{{ $responsable_nombre }}" type="text" disabled/>
                        </label>
                    </div>
                </label>
