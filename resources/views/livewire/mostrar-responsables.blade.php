        ...
        <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
                ...
                dark:text-accent dark:hover:text-primary"
                   href="{{ route('catalogos.responsables.create') }}"><i class="fa fa-plus"></i> Crear nuevo
                    responsable
                </a>
            </li>
        </ul>
                ...
                <table class="is-zebra w-full text-left" wire:loading.class="animation-unload">
                    ...
                    @foreach($responsables as $responsable)
                        <tr class="animation-load" wire:loading.class.remove="animation-load">
                            <td class="px-4 py-3 sm:px-5">{{ $responsable->nombre }}</td>
                            <td class="px-4 py-3 sm:px-5">{{ $responsable->telefono }}</td>
                            <td class="px-4 py-3 sm:px-5">{{ $responsable->email }}</td>
                            <td class="px-4 py-3 sm:px-5">
                                @isset($responsable->proyectos)
                                    <table class="w-full text-left">
                                        @foreach($responsable->proyectos as $proyecto)
                                            <tr>
                            ...
                            <td class="px-4 py-3 sm:px-5">
                                <div class="badge rounded-full  bg-info/10 text-info hover:bg-info/20">
                                    <a href="{{route('catalogos.responsables.show', $responsable->id)}}"
                                ...
                                <div
                                    ...
                                    <a href="{{route('catalogos.responsables.edit', $responsable->id)}}"
                                       title="Editar"><i
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="mt-4 px-4 sm:px-12">
                                                        ...
                                                        <p class="mt-1 text-slate-500 dark:text-navy-200">
                                                            ¿Realmente deseas eliminar al
                                                            responsable {{ $responsable->nombre }}?
                                                        </p>
                                                    </div>
                                                    <div class="space-x-3 mt-4">
                                                        <form
                                                            action="{{ route('catalogos.responsables.destroy', $responsable->id)}}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button
