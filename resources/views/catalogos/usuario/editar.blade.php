<x-app-layout title="Editar usuario" is-sidebar-open="true" is-header-blur="true">
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="col-span-12 sm:col-span-8">
                <div class="card p-4 sm:p-5">
                    ...
                    <form action="{{ route('catalogos.usuarios.update', $usuario->id) }}" method="post">
                        @method('PATCH')
                        @csrf
                    <div class="mt-4 space-y-4">
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                                <input
                                    ...
                                    name="name" required value="{{ $usuario->name }}"
                                    type="text"/>
                                <span
                            ...
                            <label class="block">
                                ...
                                <span class="relative mt-1.5 flex">
                                  <input
                                      ...
                                      name="email" required value="{{ $usuario->email }}"
                                      type="email"/>
                                  <span
                                      class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                            ...
                            <label class="block">
                                ...
                                <span class="relative mt-1.5 flex">
                                  <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                         ...
                                         name="identity" required value="{{ $usuario->identity }}"
                                         type="text" />
                        ...
                        <div x-data="{selectedNivel:'{{ $usuario->nivel }}'}">
